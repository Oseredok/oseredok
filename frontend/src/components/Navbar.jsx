    ...
    >
      <nav
        style={{
          ...
          padding: "0 24px", height: layout.navHeight, gap: 16,
        }}
      >
              ...
              {loggedInNav.map(({ id, label }) => {
                ...
                return (
                  <button
                    ...
                    style={{
                      padding: "8px 16px", borderRadius: radius.sm, fontSize: 14,
          ...
          {user ? (
            <>
              <button
                ...
                style={{ padding: "8px 18px", borderRadius: radius.pill, fontSize: 13, fontWeight: 700, border: "none", background: colors.primary, color: colors.white, cursor: "pointer", fontFamily: fonts.body }}
              >
                Мій профіль
              </button>
              <button
                type="button"
                onClick={onLogout}
                style={{ padding: "8px 16px", borderRadius: radius.pill, fontSize: 13, fontWeight: 600, border: `1px solid ${colors.border}`, background: colors.surface, color: colors.textSecondary, cursor: "pointer", fontFamily: fonts.body }}
              >
                Вийти
              </button>
            </>
            ...
            <>
              <button type="button" onClick={() => onOpenAuth("login")} style={{ padding: "8px 18px", borderRadius: radius.pill, fontSize: 14, fontWeight: 600, border: `1px solid ${colors.border}`, background: colors.surface, color: colors.text, cursor: "pointer", fontFamily: fonts.body }}>Увійти</button>
              <button type="button" onClick={() => onOpenAuth("register")} style={{ padding: "8px 18px", borderRadius: radius.pill, fontSize: 14, fontWeight: 700, border: "none", background: colors.primary, color: colors.white, cursor: "pointer", fontFamily: fonts.body }}>Реєстрація</button>
            </>
          )}
        </div>
      </nav>
